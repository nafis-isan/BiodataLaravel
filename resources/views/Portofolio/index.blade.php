...
<body>
  ...
  <section id="home" class="jumbotron text-center">
    <img src="Nafis Ikhsan2.jpg" class="img-fluid rounded-circle mb-3" style="max-width: 200px;" alt="Nafis Ikhsan">
      ...
      <div class="row g-4 justify-content-center">
        <div class="col-md-4 col-sm-6">
          <div class="card h-100 shadow-sm">
            <img src="game.png" class="card-img-top" alt="Gamer">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card h-100 shadow-sm">
            <img src="{{asset}}" class="card-img-top" alt="Artist">
            <div class="card-body text-center">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card h-100 shadow-sm">
            <img src="novel.jpg" class="card-img-top" alt="Membaca Novel">
            <div class="card-body text-center">
  ...
  <section id="projects">
    ...
    <div class="container my-5">
      <div class="row g-4 justify-content-center">
        <div class="col-md-4 col-sm-6">
          <div class="card h-100 shadow-sm">
            <img src="Sekolah dasar.png" class="card-img-top" alt="Sekolah dasar">
            <div class="card-body text-center">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card h-100 shadow-sm">
            <img src="Smp saya.jpg" class="card-img-top" alt="Sekolah Menengah Pertama">
            <div class="card-body text-center">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card h-100 shadow-sm">
            <img src="logo.png" class="card-img-top" alt="Sekolah Menengah Kejuruan">
            <div class="card-body text-center">
  ...
  <div class="content">
    <div class="container">
      ...
      <p class="text-center mb-5">Feel free to reach out through the form below or my social media links.</p>
